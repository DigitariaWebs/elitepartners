...
const AgroBusinessPage: React.FC = () => {
      ...
      <section className="relative w-full bg-gradient-to-r from-green-600 to-green-800 py-20 md:py-32 lg:py-40 px-4 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-16">
          ...
          <div className="w-full md:w-1/2 text-white">
            ...
            >
              {t('projects.agrobusiness.subtitle')}
            </motion.p>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              {t('projects.agrobusiness.description')}
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Button 
                size="lg" 
                variant="outline" 
                className="border-2 border-white text-white font-bold px-8 py-3 hover:bg-white hover:text-green-800 transition-all duration-300"
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <motion.img
              ...
              alt={t('projects.agrobusiness.title')}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-montserrat">
              {t('projects.agrobusiness.about.title')}
            </h2>
          </motion.div>
          
          <motion.div className="space-y-12">
            <motion.div
              className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border-l-4 border-green-500"
              initial="hidden"
              whileInView="visible"
            ...
            >
              <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                {t('projects.agrobusiness.about.paragraph1')}
              </p>
            </motion.div>
            ...
            >
              <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                {t('projects.agrobusiness.about.paragraph2')}
              </p>
            </motion.div>
            ...
            >
              <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                {t('projects.agrobusiness.about.paragraph3')}
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            <p className="text-gray-600 mb-6">
              {t('projects.agrobusiness.cta.interested')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/#contact">
                <Button variant="primary" size="lg" className="bg-green-600 hover:bg-green-700 text-white font-bold shadow-xl hover:shadow-2xl transition-all duration-300">
                  {t('common.contact')}
                </Button>
              </Link>
              <Link to="/about">
                <Button variant="outline" size="lg" className="border-2 border-green-300 text-green-700 hover:bg-green-50 hover:border-green-400 font-bold transition-all duration-300">
...
export default AgroBusinessPage; 