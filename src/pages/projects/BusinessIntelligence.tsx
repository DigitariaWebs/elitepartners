          ...
          <div className="w-full md:w-1/2 text-white">
            ...
            >
              <Button 
                size="lg" 
                variant="outline" 
                className="border-2 border-white text-white font-bold px-8 py-3 hover:bg-white hover:text-blue-800 transition-all duration-300"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-montserrat">
              {t('projects.bi.about.title')}
            </h2>
          </motion.div>
          
          <motion.div className="space-y-12">
            <motion.div
              className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border-l-4 border-blue-500"
              initial="hidden"
              whileInView="visible"
            ...
            >
              <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                {t('projects.bi.about.paragraph1')}
              </p>
            </motion.div>
            ...
            >
              <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                {t('projects.bi.about.paragraph2')}
              </p>
            </motion.div>
            ...
            >
              <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                {t('projects.bi.about.paragraph3')}
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            <p className="text-gray-600 mb-6">
              {t('projects.bi.cta.interested')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/#contact">
                <Button variant="primary" size="lg" className="bg-blue-600 hover:bg-blue-700 text-white font-bold shadow-xl hover:shadow-2xl transition-all duration-300">
                  {t('common.contact')}
                </Button>
              </Link>
              <Link to="/about">
                <Button variant="outline" size="lg" className="border-2 border-blue-300 text-blue-700 hover:bg-blue-50 hover:border-blue-400 font-bold transition-all duration-300">
