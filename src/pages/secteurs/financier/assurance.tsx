        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-16">
          ...
          <div className="w-full md:w-1/2 text-white">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 leading-tight font-montserrat">
              {t('sectors.financier.assurance.hero.title')}
            </h1>
            <p className="mb-8 text-base md:text-lg font-normal">
              {t('sectors.financier.assurance.hero.subtitle')}
            </p>
            <Link to="/#contact">
              <Button size="lg" variant="outline" className="border-2 border-white text-white font-bold px-8 py-3 shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 hover:bg-white hover:text-blue-900">
                {t('sectors.financier.assurance.hero.cta')}
              </Button>
            </Link>
          </div>
          {/* Image */}
          <div className="w-full md:w-1/2 flex justify-center">
            <img
              src={heroImage}
              alt={t('sectors.financier.assurance.hero.title')}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            <div className="w-full md:w-1/2 flex justify-center mb-8 md:mb-0">
              <img src={insuranceTechImage} alt={t('sectors.financier.assurance.insurtech.title')} className="rounded-2xl shadow-lg object-cover w-full max-w-md h-72 md:h-96 transition-transform duration-300 hover:scale-105" />
            </div>
            <div className="w-full md:w-1/2">
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 font-montserrat">{t('sectors.financier.assurance.insurtech.title')}</h1>
              <p className="text-gray-700 text-base md:text-lg mb-3">{t('sectors.financier.assurance.insurtech.subtitle')}</p>
              {renderBulletList(t('sectors.financier.assurance.insurtech.bullets'))}
            </div>
          </motion.div>
          ...
          >
            <div className="w-full md:w-1/2 flex justify-center mb-8 md:mb-0">
              <img src={riskAssessmentImage} alt={t('sectors.financier.assurance.risques.title')} className="rounded-2xl shadow-lg object-cover w-full max-w-md h-72 md:h-96 transition-transform duration-300 hover:scale-105" />
            </div>
            <div className="w-full md:w-1/2">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 font-montserrat">{t('sectors.financier.assurance.risques.title')}</h2>
              <p className="text-gray-700 text-base md:text-lg mb-3">{t('sectors.financier.assurance.risques.subtitle')}</p>
              {renderBulletList(t('sectors.financier.assurance.risques.bullets'))}
            </div>
          </motion.div>
          ...
          >
            <div className="w-full md:w-1/2 flex justify-center mb-8 md:mb-0">
              <img src={microInsuranceImage} alt={t('sectors.financier.assurance.micro.title')} className="rounded-2xl shadow-lg object-cover w-full max-w-md h-72 md:h-96 transition-transform duration-300 hover:scale-105" />
            </div>
            <div className="w-full md:w-1/2">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 font-montserrat">{t('sectors.financier.assurance.micro.title')}</h2>
              <p className="text-gray-700 text-base md:text-lg mb-3">{t('sectors.financier.assurance.micro.subtitle')}</p>
              {renderBulletList(t('sectors.financier.assurance.micro.bullets'))}
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            custom={4}
          >
            <p className="text-gray-600 mb-6 text-xl font-semibold">{t('sectors.financier.assurance.cta.title')}</p>
            <Link to="/#contact">
              <Button
                variant="primary"
                size="lg"
              ...
              >
                {t('sectors.financier.assurance.cta.button')}
              </Button>
            </Link>
          </motion.div>
        </div>
